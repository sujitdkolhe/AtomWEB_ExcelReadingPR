...
public class TrackerScenarios_Day_0_Test extends BaseTest {
	...
	@Test
	public void testEnterAnEntryPointsAsZeroAndTypeAsDaysInPatientProgramTabForTracker_Day_0() throws Exception {
		...
		patient.creatPatient(AtomHC.propData.getProperty("patient.p35.fname"), AtomHC.propData.getProperty("patient.p35.lname"),
		...
		patient.clickOnPatient(
				AtomHC.propData.getProperty("patient.p35.fname") + " " + AtomHC.propData.getProperty("patient.p35.lname"));
		...
		String expectedFromDateTR1 = BasePageObject.getDate_yyyy_mm_dd(0);// From Date:Today Date
		...
		log("Verify for Tracker TR1 Expected 'From Date': " + expectedFromDateTR1
				+ " and Actual 'From Date': " + actualFromDateTR1 + "  Should be Todays date");
		softAssert.assertEquals(actualFromDateTR1, expectedFromDateTR1);
		
		log("*********** Tracker TR1 'End Date' ***********");
		long add2days = 24 * 60 * 60 * 1000 * 2;
		String expectedEndDateTR1 = BasePageObject.getDate_yyyy_mm_dd(add2days); // End DATE: Today + 2 days
		log("Expected 'End date' Should be Todays + 2 days date for Tracker TR1: " + expectedEndDateTR1);
		String actualEndDateTR1 = patientTracker.getTrackerEndDate();
		log("Actual 'End Date' should be 'Todays + 2 days' date for Tracker TR1: " + actualEndDateTR1);
		log("Verify for Tracker TR1 expected 'End Date': " + expectedEndDateTR1 + "and actual 'End Date': "
				+ actualEndDateTR1 + "  Should be 'Todays + 2 days' date");
		...
		String expectedFromDateTR2 = BasePageObject.getDate_yyyy_mm_dd(add2days);// From Date: Today + 2 days
		...
		String expectedEndDateTR2 = BasePageObject.getDate_yyyy_mm_dd(add5days); // End Date: Today + 2 days + 3 days
		log("Expected 'End date' Should be 'Todays + 2 days + 3 Days' date for Tracker TR2: " + expectedEndDateTR2);
		String actualEndDateTR2 = patientTracker.getTrackerEndDate();
		log("Actual 'End Date' should be 'Todays + 2 days + 3 Days' date for Tracker TR2: " + actualEndDateTR2);
		log("Verify for Tracker TR2 expected 'End Date': " + expectedEndDateTR2 + "and actual 'End Date': "
				+ actualEndDateTR2 + "  Should be 'Todays + 2 days + 3 Days' date");
		...
		String expectedFromDateTR3 = BasePageObject.getDate_yyyy_mm_dd(add3days); // From Date: Today + 3 days
		log("Expected 'From date' Should be 'Todays + 3 days' date for Tracker TR3: " + expectedFromDateTR3);
		String actualFromDateTR3 = patientTracker.getTrackerFromDate();
		log("Actual 'From Date' should be 'Todays + 3 days' date for Tracker TR3: " + actualFromDateTR3);
		...
		String expectedEndDateTR3 = BasePageObject.getDate_yyyy_mm_dd(add5days); // End Date: Today + 3 days + 2 days
		log("Expected 'End date' Should be 'Todays + 3 days + 2 Days' date for Tracker TR3: " + expectedEndDateTR3);
		...
		log("Verify for Tracker TR3 expected 'End Date': " + expectedEndDateTR3 + "and actual 'End Date': "
				+ actualEndDateTR3 + "  Should be 'Todays + 3 days + 2 Days' date");
	...
	@Test
	public void testEnterAnEntryPointsAsFourAndTypeAsDaysInPatientProgramTabForTracker_Day_0() throws Exception {
		AtomHealthcareMainPage mainPage = new AtomHealthcareMainPage(driver);
		mainPage.clickOnOrginazationTab();
		Patients patient = new Patients(driver);
		patient.clickOnPatientsTab();
		log("Create new Patient");
		patient.clickOnAddButton();
		patient.creatPatient(AtomHC.propData.getProperty("patient.p36.fname"),
				AtomHC.propData.getProperty("patient.p36.lname"), AtomHC.propData.getProperty("patient.gender"),
		...
		log("Verify Tracker TR1 " + readExcel.getFirstTrackerName()
		...
		log("*********** Tracker TR2 'From Date' ***********");
		String expectedFromDateTR2 = BasePageObject.getDate_yyyy_mm_dd(0); //Today's date 
		log("Expected 'From date' for Tracker TR2 Should be Todays date: " + expectedFromDateTR2);
		String actualFromDateTR2 = patientTracker.getTrackerFromDate(); 
		log("Actual 'From Date' for Tracker TR2: " + actualFromDateTR2);
		log("Verify for Tracker TR2 Expected 'From Date': " + expectedFromDateTR2
				+ " and Actual 'From Date': " + actualFromDateTR2 + "  Should be Todays date");
		softAssert.assertEquals(actualFromDateTR2, expectedFromDateTR2);

		log("*********** Tracker TR2 'End Date' ***********");
		long add1Days = 24 * 60 * 60 * 1000 * 1;
		String expectedEndDateTR2 = BasePageObject.getDate_yyyy_mm_dd(add1Days); // End DATE: Tomorrow's date
		log("Expected 'End date' Should be Tomorrow's  date for Tracker TR2: " + expectedEndDateTR2);
		String actualEndDateTR2 = patientTracker.getTrackerEndDate();
		log("Actual 'End Date' should be 'Tomorrow's' date for Tracker TR2: " + actualEndDateTR2);
		log("Verify for Tracker TR2 expected 'End Date': " + expectedEndDateTR2 + "and actual 'End Date': "
				+ actualEndDateTR2 + "  Should be 'Tomorrow's' date");
		softAssert.assertEquals(actualEndDateTR2, expectedEndDateTR2);
		patientTracker.clickOnTrackerCrossIcon();
		...
		log("*********** Tracker TR3 'From Date' ***********");
		String expectedFromDateTR3 = BasePageObject.getDate_yyyy_mm_dd(0); // From Date: Todays date
		...
		log("Verify for Tracker TR3 expected 'From Date': " + expectedFromDateTR3 + "and actual 'From Date': "
				+ actualFromDateTR3 + "  Should be 'Todays' date ");
		softAssert.assertEquals(actualFromDateTR3, expectedFromDateTR3);

		log("*********** Tracker TR3 'End Date' ***********");
		String expectedEndDateTR3 = BasePageObject.getDate_yyyy_mm_dd(add1Days); // End Date: Tomorrow's date
		...
		log("*********** Tracker TR2 'From Date' ***********"); //Today's date 
		log("Expected 'From date' for Tracker TR2 Should be Todays date: " + expectedFromDateTR2);
		log("Actual 'From Date' for Tracker TR2: " + actualFromDateTR2);
		log("Verify for Tracker TR2 Expected 'From Date': " + expectedFromDateTR2
				+ " and Actual 'From Date': " + actualFromDateTR2 + "  Should be Todays date");
		...
		log("*********** Tracker TR2 'End Date' ***********");// End DATE: Tomorrow's date
		log("Expected 'End date' Should be Tomorrow's  date for Tracker TR2: " + expectedEndDateTR2);
		log("Actual 'End Date' should be 'Tomorrow's' date for Tracker TR2: " + actualEndDateTR2);
		log("Verify for Tracker TR2 expected 'End Date': " + expectedEndDateTR2 + "and actual 'End Date': "
				+ actualEndDateTR2 + "  Should be 'Tomorrow's' date");
		...
		log("*********** Tracker TR3 'From Date' ***********");// From Date: Todays date
		log("Expected 'From date' Should be 'Todays' date for Tracker TR3: " + expectedFromDateTR3);
		log("Actual 'From Date' should be 'Todays' date for Tracker TR3: " + actualFromDateTR3);
		log("Verify for Tracker TR3 expected 'From Date': " + expectedFromDateTR3 + "and actual 'From Date': "
				+ actualFromDateTR3 + "  Should be 'Todays' date ");
		...
		log("*********** Tracker TR3 'End Date' ***********"); // End Date: Tomorrow's date
		log("Expected 'End date' Should be 'Tomorrow's' date for Tracker TR3: " + expectedEndDateTR3);
		log("Actual 'End Date' should be 'Tomorrow's' date for Tracker TR3: " + actualEndDateTR3);
		log("Verify for Tracker TR3 expected 'End Date': " + expectedEndDateTR3 + "and actual 'End Date': "
				+ actualEndDateTR3 + "  Should be 'Tomorrow's' date ");
	...
	@Test
	public void testEnterAnEntryPointsAsZeroAndTypeAsDateInPatientProgramTabForTracker_Day_0() throws Exception {
		AtomHealthcareMainPage mainPage = new AtomHealthcareMainPage(driver);
		mainPage.clickOnOrginazationTab();
		Patients patient = new Patients(driver);
		patient.clickOnPatientsTab();
		log("Create new Patient");
		patient.clickOnAddButton();
		patient.creatPatient(AtomHC.propData.getProperty("patient.p37.fname"),
				AtomHC.propData.getProperty("patient.p37.lname"), AtomHC.propData.getProperty("patient.gender"),
				AtomHC.propData.getProperty("patient.birth.year"), AtomHC.propData.getProperty("patient.birth.month"),
				AtomHC.propData.getProperty("patient.birth.date"), AtomHC.propData.getProperty("patient.blood.group"),
				AtomHC.propData.getProperty("patient.lang.preferance"),
				AtomHC.propData.getProperty("patient.security.code"),
	...
	@Test
	public void testEnterAnEntryPointsAsFourAndTypeAsDateInPatientProgramTabForTracker_Day_0() throws Exception {
		AtomHealthcareMainPage mainPage = new AtomHealthcareMainPage(driver);
		mainPage.clickOnOrginazationTab();
		Patients patient = new Patients(driver);
		patient.clickOnPatientsTab();
		log("Create new Patient");
		patient.clickOnAddButton();
		patient.creatPatient(AtomHC.propData.getProperty("patient.p38.fname"),
				AtomHC.propData.getProperty("patient.p38.lname"), AtomHC.propData.getProperty("patient.gender"),
				AtomHC.propData.getProperty("patient.birth.year"), AtomHC.propData.getProperty("patient.birth.month"),
				AtomHC.propData.getProperty("patient.birth.date"), AtomHC.propData.getProperty("patient.blood.group"),
				AtomHC.propData.getProperty("patient.lang.preferance"),
				AtomHC.propData.getProperty("patient.security.code"),
		...
		log("*********** Tracker TR2 'From Date' ***********");
		String expectedFromDateTR2 = BasePageObject.getDate_yyyy_mm_dd(0);// From Date: Today's date 
		log("Expected 'From date' for Tracker TR2 Should be Todays date: " + expectedFromDateTR2);
		String actualFromDateTR2 = patientTracker.getTrackerFromDate();
		log("Actual 'From Date' for Tracker TR2: " + actualFromDateTR2);
		log("Verify for Tracker TR2 Expected 'From Date': " + expectedFromDateTR2
		...
		log("*********** Tracker TR3 'From Date' ***********");
		String expectedFromDateTR3 = BasePageObject.getDate_yyyy_mm_dd(0); // From Date: Today date
		log("Expected 'From date' Should be 'Todays' date for Tracker TR3: " + expectedFromDateTR3);
		String actualFromDateTR3 = patientTracker.getTrackerFromDate();
		log("Actual 'From Date' should be 'Todays' date for Tracker TR3: " + actualFromDateTR3);
		log("Verify for Tracker TR3 expected 'From Date': " + expectedFromDateTR3 + "and actual 'From Date': "
		...
		log("************************************************** Caregiver C3 **************************************************");
		log("Login to second caregiver C2 : "+readExcel.getThirdCaregiverName());
		appointemetPage.login(readExcel.getThirdCaregiverUsername(),
				AtomHC.key.getDecrypt(readExcel.getThirdCaregiverPassword()),
				AtomHC.propData.getProperty("atom.verification.key"));
		mainPage.clickOnOrginazationTab();
		...
		log("*********** Tracker TR2 'From Date' ***********");// From Date: Today's date 
		log("Expected 'From date' for Tracker TR2 Should be Todays date: " + expectedFromDateTR2);
		log("Actual 'From Date' for Tracker TR2: " + actualFromDateTR2);
		log("Verify for Tracker TR2 Expected 'From Date': " + expectedFromDateTR2
				+ " and Actual 'From Date': " + actualFromDateTR2 + "  Should be Todays date ");
		...
		log("*********** Tracker TR3 'From Date' ***********"); // From Date: Today date
		log("Expected 'From date' Should be 'Todays' date for Tracker TR3: " + expectedFromDateTR3);
		log("Actual 'From Date' should be 'Todays' date for Tracker TR3: " + actualFromDateTR3);
		log("Verify for Tracker TR3 expected 'From Date': " + expectedFromDateTR3 + "and actual 'From Date': "
				+ actualFromDateTR3 + "  Should be 'Todays' date in Red color");
	...
	@Test
	public void testEnterAnEntryPointsAsZeroAndTypeAsTrackerInPatientProgramTabForTracker_Day_0() throws Exception {
		AtomHealthcareMainPage mainPage = new AtomHealthcareMainPage(driver);
		mainPage.clickOnOrginazationTab();
		Patients patient = new Patients(driver);
		patient.clickOnPatientsTab();
		log("Create new Patient");
		patient.clickOnAddButton();
		patient.creatPatient(AtomHC.propData.getProperty("patient.p39.fname"),
				AtomHC.propData.getProperty("patient.p39.lname"), AtomHC.propData.getProperty("patient.gender"),
				AtomHC.propData.getProperty("patient.birth.year"), AtomHC.propData.getProperty("patient.birth.month"),
				AtomHC.propData.getProperty("patient.birth.date"), AtomHC.propData.getProperty("patient.blood.group"),
				AtomHC.propData.getProperty("patient.lang.preferance"),
				AtomHC.propData.getProperty("patient.security.code"),
		...
		log("*********** Tracker TR1 'From Date' ***********");
		String expectedFromDateTR1 = BasePageObject.getDate_yyyy_mm_dd(0);// From Date:Today's date
		log("Expected 'From date' for Tracker TR1 Should be Todays date: " + expectedFromDateTR1);
		String actualFromDateTR1 = patientTracker.getTrackerFromDate();
		log("Actual 'From Date' for Tracker TR1: " + actualFromDateTR1);
		log("Verify for Tracker TR1 Expected 'From Date': " + expectedFromDateTR1
	...
	@Test
	public void testEnterAnEntryPointsAsFourAndTypeAsTrackerInPatientProgramTabForTracker_Day_0() throws Exception {
		AtomHealthcareMainPage mainPage = new AtomHealthcareMainPage(driver);
		mainPage.clickOnOrginazationTab();
		Patients patient = new Patients(driver);
		patient.clickOnPatientsTab();
		log("Create new Patient");
		patient.clickOnAddButton();
		patient.creatPatient(AtomHC.propData.getProperty("patient.p40.fname"),
				AtomHC.propData.getProperty("patient.p40.lname"), AtomHC.propData.getProperty("patient.gender"),
				AtomHC.propData.getProperty("patient.birth.year"), AtomHC.propData.getProperty("patient.birth.month"),
				AtomHC.propData.getProperty("patient.birth.date"), AtomHC.propData.getProperty("patient.blood.group"),
				AtomHC.propData.getProperty("patient.lang.preferance"),
				AtomHC.propData.getProperty("patient.security.code"),
		...
		log("Verify Tracker TR1 " +readExcel.getFirstTrackerName()
				+ " Should not be Visible in Caregiver TR2");
		softAssert.assertFalse(patientTracker.isTrackerDisplay(readExcel.getFirstTrackerName()),
				readExcel.getSecondTrackerName());

		log("Verify Caregiver TR2 Should be Visible: " + readExcel.getSecondTrackerName());
		softAssert.assertEquals(patientTracker.getTrackerName(readExcel.getSecondTrackerName()),
				readExcel.getSecondTrackerName());
		patientTracker.clickOnTrackerName(readExcel.getSecondTrackerName());
		
		log("*********** Tracker TR2 'From Date' ***********");
		String expectedFromDateTR2 = BasePageObject.getDate_yyyy_mm_dd(0);
		log("Expected 'From date' for Tracker TR2 Should be Todays date: " + expectedFromDateTR2);
		String actualFromDateTR2 = patientTracker.getTrackerFromDate();// From Date:Today's date 
		log("Actual 'From Date' for Tracker TR2: " + actualFromDateTR2);
		log("Verify for Tracker TR2 Expected 'From Date': " + expectedFromDateTR2
				+ " and Actual 'From Date': " + actualFromDateTR2 + "  Should be Todays date in Red color");
		softAssert.assertEquals(actualFromDateTR2, expectedFromDateTR2);
		...
		log("Verify Caregiver TR3 Should be Visible: " + readExcel.getThirdTrackerName());
		softAssert.assertEquals(patientTracker.getTrackerName(readExcel.getThirdTrackerName()),
				readExcel.getThirdTrackerName());
		patientTracker.clickOnTrackerName(readExcel.getThirdTrackerName());
		...
		log("Actual 'End Date' should be 'Tomorrow's' date for Tracker TR3: " + actualEndDateTR3);
		log("Verify for Tracker TR3 expected 'End Date': " + expectedEndDateTR3 + "and actual 'End Date': "
				+ actualEndDateTR3 + "  Should be 'Tomorrow's' date in Red color ");
		softAssert.assertEquals(actualEndDateTR3, expectedEndDateTR3);
		patientTracker.clickOnTrackerCrossIcon();
		log("Logout from second caregiver TR2");
		mainPage.logout();
		...
		log("*********** Tracker TR2 'From Date' ***********");
		log("Expected 'From date' for Tracker TR2 Should be Todays date: " + expectedFromDateTR2);// From Date:Today's date 
		log("Actual 'From Date' for Tracker TR2: " + actualFromDateTR2);
		log("Verify for Tracker TR2 Expected 'From Date': " + expectedFromDateTR2
				+ " and Actual 'From Date': " + actualFromDateTR2 + "  Should be Todays date");
		softAssert.assertEquals(actualFromDateTR2, expectedFromDateTR2);
	...
	@Test
	public void testSubscribeProgramEnterAnEntryPointsAsZeroAndTypeAsDaysInPatientProgramTabForTracker_Day_0() throws Exception {
		AtomHealthcareMainPage mainPage = new AtomHealthcareMainPage(driver);
		mainPage.clickOnOrginazationTab();
		Patients patient = new Patients(driver);
		patient.clickOnPatientsTab();
		log("Create new Patient");
		patient.clickOnAddButton();
		patient.creatPatient(AtomHC.propData.getProperty("patient.p41.fname"),
				AtomHC.propData.getProperty("patient.p41.lname"), AtomHC.propData.getProperty("patient.gender"),
				AtomHC.propData.getProperty("patient.birth.year"), AtomHC.propData.getProperty("patient.birth.month"),
				AtomHC.propData.getProperty("patient.birth.date"), AtomHC.propData.getProperty("patient.blood.group"),
				AtomHC.propData.getProperty("patient.lang.preferance"),
				AtomHC.propData.getProperty("patient.security.code"),
		...
		log("************************************************** Caregiver C4 **************************************************");
		log("Login to fourth caregiver TR4");
		HealthcareLogin appointemetPage = new HealthcareLogin(driver, AtomHC.propData.getProperty("url"));
		driver.navigate().refresh();
		...
		String expectedFromDateTR4 = BasePageObject.getDate_yyyy_mm_dd(0);// From Date:Today
		log("Expected 'From date' for Medication TR4 Should be Todays date: " + expectedFromDateTR4);
		String actualFromDateTR4 = patientTracker.getTrackerFromDate();
		log("Actual 'From Date' for Tracker TR4: " + actualFromDateTR4);
		log("Verify for Tracker TR4 Expected 'From Date': " + expectedFromDateTR4
				+ " and Actual 'From Date': " + actualFromDateTR4 + "  Should be Todays date");
		softAssert.assertEquals(actualFromDateTR4, expectedFromDateTR4);

		log("*********** Tracker TR4 'End Date' ***********");
		long add2days = 24 * 60 * 60 * 1000 * 2;
		String expectedEndDateTR4 = BasePageObject.getDate_yyyy_mm_dd(add2days); // End DATE: Today + 2 days
		log("Expected 'End date' Should be Todays + 2 days date for Tracker TR4: " + expectedEndDateTR4);
		String actualEndDateTR4 = patientTracker.getTrackerEndDate();
		log("Actual 'End Date' should be 'Todays + 2 days' date for Tracker TR4: " + actualEndDateTR4);
		log("Verify for Tracker TR4 expected 'End Date': " + expectedEndDateTR4 + "and actual 'End Date': "
				+ actualEndDateTR4 + "  Should be 'Todays + 2 days' date");
		softAssert.assertEquals(actualEndDateTR4, expectedEndDateTR4);
		patientTracker.clickOnTrackerCrossIcon();
		...
		String expectedFromDateTR5 = BasePageObject.getDate_yyyy_mm_dd(add2days);// From Date: Today + 2 days
		log("Expected 'From date' Should be 'Todays + 2 days' date for Tracker TR5: " + expectedFromDateTR5);
		String actualFromDateTR5 = patientTracker.getTrackerFromDate();
		log("Actual 'From Date' should be 'Todays + 2 days' date for Tracker TR5: " + actualFromDateTR5);
		log("Verify for Tracker TR5 expected 'From Date': " + expectedFromDateTR5 + "and actual 'From Date': "
				+ actualFromDateTR5 + "  Should be 'Todays + 2 days' date");
		softAssert.assertEquals(actualFromDateTR5, expectedFromDateTR5);

		log("*********** Tracker TR5 'End Date' ***********");
		long add5days = 24 * 60 * 60 * 1000 * 5;
		String expectedEndDateTR5 = BasePageObject.getDate_yyyy_mm_dd(add5days); // End Date: Today + 2 days + 3 days
		log("Expected 'End date' Should be 'Todays + 2 days + 3 Days' date for Tracker TR5: " + expectedEndDateTR5);
		String actualEndDateTR5 = patientTracker.getTrackerEndDate();
		log("Actual 'End Date' should be 'Todays + 2 days + 3 Days' date for Tracker TR5: " + actualEndDateTR5);
		log("Verify for Tracker TR5 expected 'End Date': " + expectedEndDateTR5 + "and actual 'End Date': "
				+ actualEndDateTR5 + "  Should be 'Todays + 2 days + 3 Days' date");
		...
		long add3days = 24 * 60 * 60 * 1000 * 3;
		String expectedFromDateTR6 = BasePageObject.getDate_yyyy_mm_dd(add3days);// From Date: Today + 3 days
		log("Expected 'From date' Should be 'Todays + 3 days' date for Tracker TR6: " + expectedFromDateTR6);
		String actualFromDateTR6 = patientTracker.getTrackerFromDate();
		log("Actual 'From Date' should be 'Todays + 3 days' date for Tracker TR6: " + actualFromDateTR6);
		log("Verify for Tracker TR6 expected 'From Date': " + expectedFromDateTR6 + "and actual 'From Date': "
				+ actualFromDateTR6 + "  Should be 'Todays + 3 days' date");
		softAssert.assertEquals(actualFromDateTR6, expectedFromDateTR6);

		log("*********** Tracker TR6 'End Date' ***********");
		String expectedEndDateTR6 = BasePageObject.getDate_yyyy_mm_dd(add5days); // End Date: Today + 2 days + 3 days
		log("Expected 'End date' Should be 'Todays + 2 days + 3 Days' date for Tracker TR5: " + expectedEndDateTR6);
		String actualEndDateTR6 = patientTracker.getTrackerEndDate();
		log("Actual 'End Date' should be 'Todays + 2 days + 3 Days' date for Tracker TR5: " + actualEndDateTR6);
		log("Verify for Tracker TR6 expected 'End Date': " + expectedEndDateTR6 + "and actual 'End Date': "
				+ actualEndDateTR6 + "  Should be 'Todays + 2 days + 3 Days' date");
		softAssert.assertEquals(actualEndDateTR6, expectedEndDateTR6);
		patientTracker.clickOnTrackerCrossIcon();
		log("Logout from fourth caregiver TR4");
		mainPage.logout();
	...
	@Test
	public void testSubscribeProgramEnterAnEntryPointsAsZeroAndTypeAsDateInPatientProgramTabForTracker_Day_0() throws Exception {
		AtomHealthcareMainPage mainPage = new AtomHealthcareMainPage(driver);
		mainPage.clickOnOrginazationTab();
		Patients patient = new Patients(driver);
		patient.clickOnPatientsTab();
		log("Create new Patient");
		patient.clickOnAddButton();
		patient.creatPatient(AtomHC.propData.getProperty("patient.p42.fname"),
				AtomHC.propData.getProperty("patient.p42.lname"), AtomHC.propData.getProperty("patient.gender"),
				AtomHC.propData.getProperty("patient.birth.year"), AtomHC.propData.getProperty("patient.birth.month"),
				AtomHC.propData.getProperty("patient.birth.date"), AtomHC.propData.getProperty("patient.blood.group"),
				AtomHC.propData.getProperty("patient.lang.preferance"),
				AtomHC.propData.getProperty("patient.security.code"),
		...
		log("************************************************** Caregiver C4 **************************************************");
		log("Login to fourth caregiver C3 : "+readExcel.getFourthCaregiverName());
		HealthcareLogin appointemetPage = new HealthcareLogin(driver, AtomHC.propData.getProperty("url"));
		driver.navigate().refresh();
		appointemetPage.login(readExcel.getFourthCaregiverUsername(),
				AtomHC.key.getDecrypt(readExcel.getFourthCaregiverPassword()),
		...
		long add2days = 24 * 60 * 60 * 1000 * 2;
		String expectedEndDateTR4 = BasePageObject.getDate_yyyy_mm_dd(add2days); // End DATE: Today + 2 days
		log("Expected 'End date' Should be Todays + 2 days date for Medication TR4: " + expectedEndDateTR4);
		String actualEndDateTR4 = patientTracker.getTrackerEndDate();
		log("Actual 'End Date' should be 'Todays + 2 days' date for Medication TR4: " + actualEndDateTR4);
		log("Verify for Tracker TR4 expected 'End Date': " + expectedEndDateTR4 + "and actual 'End Date': "
				+ actualEndDateTR4 + "  Should be 'Todays + 2 days' date");
		softAssert.assertEquals(actualEndDateTR4, expectedEndDateTR4);
		patientTracker.clickOnTrackerCrossIcon();
		...
		log("*********** Tracker TR6 'End Date' ***********");
		String expectedEndDateTR6 = BasePageObject.getDate_yyyy_mm_dd(add5days); // End Date: Today + 2 days + 3 days
		log("Expected 'End date' Should be 'Todays + 2 days + 3 Days' date for Tracker TR6: " + expectedEndDateTR6);
		String actualEndDateTR6 = patientTracker.getTrackerEndDate();
		log("Actual 'End Date' should be 'Todays + 2 days + 3 Days' date for Tracker TR6: " + actualEndDateTR6);
		log("Verify for Tracker TR6 expected 'End Date': " + expectedEndDateTR6 + "and actual 'End Date': "
				+ actualEndDateTR6 + "  Should be 'Todays + 2 days + 3 Days' date");
		softAssert.assertEquals(actualEndDateTR6, expectedEndDateTR6);
		patientTracker.clickOnTrackerCrossIcon();
	...
	@Test
	public void testSubscribeProgramEnterAnEntryPointsAsZeroAndTypeAsTrackerInPatientProgramTabForTracker_Day_0() throws Exception {
		AtomHealthcareMainPage mainPage = new AtomHealthcareMainPage(driver);
		mainPage.clickOnOrginazationTab();
		Patients patient = new Patients(driver);
		patient.clickOnPatientsTab();
		log("Create new Patient");
		patient.clickOnAddButton();
		patient.creatPatient(AtomHC.propData.getProperty("patient.p43.fname"),
				AtomHC.propData.getProperty("patient.p43.lname"), AtomHC.propData.getProperty("patient.gender"),
				AtomHC.propData.getProperty("patient.birth.year"), AtomHC.propData.getProperty("patient.birth.month"),
				AtomHC.propData.getProperty("patient.birth.date"), AtomHC.propData.getProperty("patient.blood.group"),
				AtomHC.propData.getProperty("patient.lang.preferance"),
				AtomHC.propData.getProperty("patient.security.code"),
		...
		log("*********** Tracker TR4 'From Date' ***********");
		String expectedFromDateTR4 = BasePageObject.getDate_yyyy_mm_dd(0);// From Date:Today's Date
		log("Expected 'From date' for Medication TR4 Should be Todays date: " + expectedFromDateTR4);
		String actualFromDateTR4 = patientTracker.getTrackerFromDate();
		log("Actual 'From Date' for Tracker TR4: " + actualFromDateTR4);
		log("Verify for Tracker TR4 Expected 'From Date': " + expectedFromDateTR4
				+ " and Actual 'From Date': " + actualFromDateTR4 + "  Should be Today's date");
		softAssert.assertEquals(actualFromDateTR4, expectedFromDateTR4);
