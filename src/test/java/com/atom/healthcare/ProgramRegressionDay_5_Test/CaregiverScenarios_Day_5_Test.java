...
public class CaregiverScenarios_Day_5_Test extends BaseTest {
	HealthcareLogin appointemetPage;
	RegisterPage registerPage;
	ReadExcel readExcel;

	@Test
	public void testEnterAnEntryPointsAsZeroAndTypeAsDaysInPatientProgramTabForCaregiver_Day_5() throws Exception {
		log("************************************************** Caregiver C1 **************************************************");
		...
		long fiveDayBeforeDate = -24 * 60 * 60 * 1000 * 5;
		String expectedFromDateC1 = BasePageObject.getEpochConvertDate(fiveDayBeforeDate);// 5 day before date
		log("Expected 'From date' for caregiver C1 Should be 5 day before date: " + expectedFromDateC1);
		...
		log("Verify for Caregiver C1 Expected 'From Date': " + expectedFromDateC1 + " and Actual 'From Date': "
				+ actualFromDateC1 + "  Should be 5 day before date in 'Red Color'");
		...
		String expectedEndDateC1 = BasePageObject.getEpochTimeInDate(threeDayBeforeDate); // End DATE: 3 day before date
		String actualEndDateC1 = patientCaregiver.getEndDate(readExcel.getFirstCaregiverName());
		log("Expected 'End date' Should be '3 day before' date for caregiver C1: " + expectedEndDateC1);
		log("Actual 'End Date' should be '3 day before ' date for caregiver C1: " + actualEndDateC1);
		log("Verify for Caregiver C1 expected 'End Date': " + expectedEndDateC1 + "and actual 'End Date': "
				+ actualEndDateC1 + "  Should be '3 day before' date in 'Red Color'");
		...
		String expectedFromDateC2 = BasePageObject.getEpochTimeInDate(threeDayBeforeDate);// From Date: 3 day before date
		log("Expected 'From date' Should be '3 day before' date for caregiver C2: " + expectedFromDateC2);
		String actualFromDateC2 = patientCaregiver.getFromDate(readExcel.getSecondCaregiverName());
		log("Actual 'From Date' should be '3 day before' date for caregiver C2: " + actualFromDateC2);
		log("Verify for Caregiver C2 expected 'From Date': " + expectedFromDateC2 + "and actual 'From Date': "
				+ actualFromDateC2 + "  Should be '3 day before' date in 'Red Color'");
		...
		String expectedEndDateC2 = BasePageObject.getEpochTimeInDate(0); // End Date: Todays date
		log("Expected 'End date' Should be 'Todays date' date for caregiver C2: " + expectedEndDateC2);
		String actualEndDateC2 = patientCaregiver.getEndDate(readExcel.getSecondCaregiverName());
		log("Actual 'End Date' should be 'Todays date' date for caregiver C2: " + actualEndDateC2);
		log("Verify for Caregiver C2 expected 'End Date': " + expectedEndDateC2 + "and actual 'End Date': "
				+ actualEndDateC2 + "  Should be 'Todays' date in 'Red Color'");
		...
		String expectedFromDateC3 = BasePageObject.getEpochTimeInDate(twoDayBeforeDate); // From Date: 2 day before date
		log("Expected 'From date' Should be '2 day before' date for caregiver C3: " + expectedFromDateC3);
		String actualFromDateC3 = patientCaregiver.getFromDate(readExcel.getThirdCaregiverName());
		log("Actual 'From Date' should be '2 day before' date for caregiver C3: " + actualFromDateC3);
		log("Verify for Caregiver C3 expected 'From Date': " + expectedFromDateC3 + "and actual 'From Date': "
				+ actualFromDateC3 + "  Should be '2 day before' date in 'Red Color'");
		...
		String expectedEndDateC3 = BasePageObject.getEpochTimeInDate(0); // End Date: Todays date
		log("Expected 'End date' Should be 'Todays' date for caregiver C3: " + expectedEndDateC3);
		String actualEndDateC3 = patientCaregiver.getEndDate(readExcel.getThirdCaregiverName());
		log("Actual 'End Date' should be 'Todays' date for caregiver C3: " + actualEndDateC3);
		log("Verify for Caregiver C3 expected 'End Date': " + expectedEndDateC3 + "and actual 'End Date': "
				+ actualEndDateC3 + "  Should be 'Todays' date in 'Red Color'");
		...
		log("*********** Caregiver C1 'From Date' ***********");
		log("Expected 'From date' for caregiver C1 Should be 5 day before date: " + expectedFromDateC1);
		log("Actual 'From Date' for caregiver C1: " + actualFromDateC1); // 5 day before date
		log("Verify for Caregiver C1 Expected 'From Date': " + expectedFromDateC1 + " and Actual 'From Date': "
				+ actualFromDateC1 + "  Should be 5 day before date in 'Red Color'");
		softAssert.assertEquals(actualFromDateC1, expectedFromDateC1);
		softAssert.assertEquals(patientCaregiver.getCaregiverFromDateColor(readExcel.getFirstCaregiverName()),
		...
		log("*********** Caregiver C1 'End Date' ***********");// End DATE: 3 day before date
		log("Expected 'End date' Should be '3 day before' date for caregiver C1: " + expectedEndDateC1);
		log("Actual 'End Date' should be '3 day before ' date for caregiver C1: " + actualEndDateC1);
		log("Verify for Caregiver C1 expected 'End Date': " + expectedEndDateC1 + "and actual 'End Date': "
				+ actualEndDateC1 + "  Should be '3 day before' date in 'Red Color'");
		...
		log("*********** Caregiver C2 'From Date' ***********");// From Date: 3 day before date
		log("Expected 'From date' Should be '3 day before' date for caregiver C2: " + expectedFromDateC2);
		log("Actual 'From Date' should be '3 day before' date for caregiver C2: " + actualFromDateC2);
		log("Verify for Caregiver C2 expected 'From Date': " + expectedFromDateC2 + "and actual 'From Date': "
				+ actualFromDateC2 + "  Should be '3 day before' date in 'Red Color'");
		...
		log("*********** Caregiver C2 'End Date' ***********");// End Date: Todays date
		log("Expected 'End date' Should be 'Todays date' date for caregiver C2: " + expectedEndDateC2);
		log("Actual 'End Date' should be 'Todays date' date for caregiver C2: " + actualEndDateC2);
		log("Verify for Caregiver C2 expected 'End Date': " + expectedEndDateC2 + "and actual 'End Date': "
				+ actualEndDateC2 + "  Should be 'Todays' date in 'Red Color'");
		...
		log("*********** Caregiver C3 'From Date' ***********");// From Date: 2 day before date
		log("Expected 'From date' Should be '2 day before' date for caregiver C3: " + expectedFromDateC3);
		log("Actual 'From Date' should be '2 day before' date for caregiver C3: " + actualFromDateC3);
		log("Verify for Caregiver C3 expected 'From Date': " + expectedFromDateC3 + "and actual 'From Date': "
				+ actualFromDateC3 + "  Should be '2 day before' date in 'Red Color'");
		...
		log("*********** Caregiver C3 'End Date' ***********");// End Date: Todays date
		log("Expected 'End date' Should be 'Todays' date for caregiver C3: " + expectedEndDateC3);
		log("Actual 'End Date' should be 'Todays' date for caregiver C3: " + actualEndDateC3);
		log("Verify for Caregiver C3 expected 'End Date': " + expectedEndDateC3 + "and actual 'End Date': "
				+ actualEndDateC3 + "  Should be 'Todays' date in 'Red Color'");
	...
	@Test
	public void testEnterAnEntryPointsAsFourAndTypeAsDaysInPatientProgramTabForCaregiver_Day_5() throws Exception {
		log("************************************************** Caregiver C1 **************************************************");
		readExcel = new ReadExcel();
		log("Login to first caregiver C1: " + readExcel.getFirstCaregiverName());
		HealthcareLogin appointemetPage = new HealthcareLogin(driver, AtomHC.propData.getProperty("url"));
	...
	@Test
	public void testEnterAnEntryPointsAsZeroAndTypeAsDateInPatientProgramTabForCaregiver_Day_5() throws Exception {
		log("************************************************** Caregiver C1 **************************************************");
		readExcel = new ReadExcel();
		log("Login to First caregiver C1: " + readExcel.getFirstCaregiverName());
		HealthcareLogin appointemetPage = new HealthcareLogin(driver, AtomHC.propData.getProperty("url"));
		...
		log("*********** Caregiver C1 'From Date' ***********");
		long fiveDayBeforeDate = -24 * 60 * 60 * 1000 * 5;
		String expectedFromDateC1 = BasePageObject.getEpochConvertDate(fiveDayBeforeDate);
		log("Expected 'From date' for caregiver C1 Should be 5 day before date: " + expectedFromDateC1);
		String actualFromDateC1 = patientCaregiver.getFromDate(readExcel.getFirstCaregiverName());// 5 day before date
		log("Actual 'From Date' for caregiver C1: " + actualFromDateC1);
		log("Verify for Caregiver C1 Expected 'From Date': " + expectedFromDateC1 + " and Actual 'From Date': "
				+ actualFromDateC1 + "  Should be 5 day before date in 'Red Color'");
		softAssert.assertEquals(actualFromDateC1, expectedFromDateC1);
		...
		log("*********** Caregiver C2 'From Date' ***********");// From Date: 3 day before date
		String expectedFromDateC2 = BasePageObject.getEpochTimeInDate(threeDayBeforeDate);
		log("Expected 'From date' Should be '3 day before' date for caregiver C2: " + expectedFromDateC2);
		String actualFromDateC2 = patientCaregiver.getFromDate(readExcel.getSecondCaregiverName());
		log("Actual 'From Date' should be '3 day before' date for caregiver C2: " + actualFromDateC2);
		log("Verify for Caregiver C2 expected 'From Date': " + expectedFromDateC2 + "and actual 'From Date': "
		...
		log("*********** Caregiver C1 'From Date' ***********");// 5 day before date
		log("Expected 'From date' for caregiver C1 Should be 5 day before date: " + expectedFromDateC1);
		log("Actual 'From Date' for caregiver C1: " + actualFromDateC1); 
		log("Verify for Caregiver C1 Expected 'From Date': " + expectedFromDateC1 + " and Actual 'From Date': "
				+ actualFromDateC1 + "  Should be 5 day before date in 'Red Color'");
	...
	@Test
	public void testEnterAnEntryPointsAsFourAndTypeAsDateInPatientProgramTabForCaregiver_Day_5() throws Exception {
		log("************************************************** Caregiver C1 **************************************************");
		readExcel = new ReadExcel();
		log("Login to first caregiver C1: " + readExcel.getFirstCaregiverName());
		HealthcareLogin appointemetPage = new HealthcareLogin(driver, AtomHC.propData.getProperty("url"));
	...
	@Test
	public void testEnterAnEntryPointsAsZeroAndTypeAsTrackerInPatientProgramTabForCaregiver_Day_5() throws Exception {
		log("************************************************** Caregiver C1 **************************************************");
		readExcel = new ReadExcel();
		log("Login to first caregiver C1: " + readExcel.getFirstCaregiverName());
		HealthcareLogin appointemetPage = new HealthcareLogin(driver, AtomHC.propData.getProperty("url"));
	...
	@Test
	public void testEnterAnEntryPointsAsFourAndTypeAsTrackerInPatientProgramTabForCaregiver_Day_5() throws Exception {
		log("************************************************** Caregiver C1 **************************************************");
		readExcel = new ReadExcel();
		log("Login to first caregiver C1: " + readExcel.getFirstCaregiverName());
		HealthcareLogin appointemetPage = new HealthcareLogin(driver, AtomHC.propData.getProperty("url"));
	...
	@Test
	public void testSubscribeProgramEnterAnEntryPointsAsZeroAndTypeAsDaysInPatientProgramTabForCaregiver_Day_5()
			throws Exception {
		log("************************************************** Caregiver C4 **************************************************");
		readExcel = new ReadExcel();
		...
		long fiveDayBefore = -24 * 60 * 60 * 1000 * 5;
		String expectedFromDateC4 = BasePageObject.getEpochConvertDate(fiveDayBefore);
		log("Expected 'From date' for caregiver C4 Should be four days before date: " + expectedFromDateC4);
		String actualFromDateC4 = patientCaregiver.getFromDate(readExcel.getFourthCaregiverName());// From Date : five day before date
		log("Actual 'From Date' for caregiver C4: " + actualFromDateC4);
		log("Verify for Caregiver C4 Expected 'From Date': " + expectedFromDateC4
				+ " and Actual 'From Date': " + actualFromDateC4 + "  Should be Before five day date");
		...
		String expectedEndDateC4 = BasePageObject.getEpochTimeInDate(threeDayBefore); // End DATE: three day before Date
		log("Expected 'End date' Should be three day before date for caregiver C1: " + expectedEndDateC4);
		String actualEndDateC4 = patientCaregiver.getEndDate(readExcel.getFourthCaregiverName());
		log("Actual 'End Date' should be 'three day before' date for caregiver C1: " + actualEndDateC4);
		log("Verify for Caregiver C4 expected 'End Date': " + expectedEndDateC4 + "and actual 'End Date': "
				+ actualEndDateC4 + "  Should be 'three day before' date");
		...
		String expectedFromDateC5 = BasePageObject.getEpochTimeInDate(threeDayBefore);// From Date: three day before Date
		log("Expected 'From date' Should be 'three day before' date for caregiver C5: " + expectedFromDateC5);
		String actualFromDateC5 = patientCaregiver.getFromDate(readExcel.getFifthCaregiverName());
		log("Actual 'From Date' should be 'three day before' date for caregiver C5: " + actualFromDateC5);
		log("Verify for Caregiver C5 expected 'From Date': " + expectedFromDateC5 + "and actual 'From Date': "
				+ actualFromDateC5 + "  Should be 'three day before' date");
		softAssert.assertEquals(actualFromDateC5, expectedFromDateC5);
		softAssert.assertEquals(patientCaregiver.getCaregiverFromDateColor(readExcel.getFifthCaregiverName()),
				AtomHC.propData.getProperty("error.color"));

		log("*********** Caregiver C5 'End Date' ***********");
		String expectedEndDateC5 = BasePageObject.getEpochTimeInDate(0); // End Date: Today date
		log("Expected 'End date' Should be 'Today date' date for caregiver C5: " + expectedEndDateC5);
		String actualEndDateC5 = patientCaregiver.getEndDate(readExcel.getFifthCaregiverName());
		log("Actual 'End Date' should be 'Today date' date for caregiver C5: " + actualEndDateC5);
		log("Verify for Caregiver C5 expected 'End Date': " + expectedEndDateC5 + "and actual 'End Date': "
				+ actualEndDateC5 + "  Should be 'Todays' date");
		softAssert.assertEquals(actualEndDateC5, expectedEndDateC5);
		softAssert.assertEquals(patientCaregiver.getCaregiverEndDateColor(readExcel.getFifthCaregiverName()),
				AtomHC.propData.getProperty("error.color"));
