package com.atom.healthcare.EducationMaster;
...
public class EducationMaster extends BasePageObject {

	public EducationMaster(WebDriver driver) {
		super(driver);
	...
	public void createEducation(String eduTitle) {
		TestConfig.PrintMethodName();
		waitForElement(driver, educationAddButton);
		javascriptClick(educationAddButton);
		waitForElement(driver, educationCategoryDropdown);
		educationCategoryDropdown.click();
		educationCategoryOption.click();
		educationFirstTitleTextbox.sendKeys(eduTitle);
		educationFirstEditorTextbox.sendKeys(eduTitle);
		educationSecondLang.click();
		educationSeconLangTextbox.sendKeys(eduTitle);
		educationSecondEditorTextbox.sendKeys(eduTitle);
		educationSaveButton.click();
	}

	public void publishEducation(String eduTitle) {
		TestConfig.PrintMethodName();
		WebElement element = driver.findElement(By.xpath("//label[text()='" + eduTitle + "']"));
		javascriptClick(element);
		try {
			javascriptClick(educationUnPublishButton);
			log("Education already publish");
		} catch (Exception e) {
			javascriptClick(publishButton);
			publishOKButton.click();
		}
	}
}
